...
class Recursive(CrawlSpider):
    ...
    def parse_event_detail(self, response):
        ...
        loader.add_xpath('promoter',        './/p[@class="event-sponsor"]/text()')
    ...
    def parse(self, response):
        ...
        for event in selector.xpath(self.events_list_xpath):
            ...
            loader.add_xpath('event_url',   './a/@href')
            ...
            loader.add_xpath('event_ts',    './/div[@class="event-date dtstart"]/span[@class="value-title"]/@title')
            loader.add_xpath('ticket_price','.//div[@class="event-results-ticket-price"]/'
            ...
            loader.add_xpath('purchase_url','.//div[@class="event-results-ticket-price"]/'
                                            'span[@class="ticket-link primary-link"]/'
